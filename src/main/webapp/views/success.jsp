...
<head>
    ...
    <style>
        .card {
            border: 2px solid #C4B6AB; /* Dark border color */
            background-color: #C4B6AB; /* Light background color */
            margin-bottom: 20px;
        }
...
<nav class="navbar navbar-expand-lg navbar-light bg-clr">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Uruchi Job Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:8080/home">Contact</a>
                </li>
            </ul>
        </div>
    </div>
