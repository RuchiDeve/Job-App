...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Uruchi Job
            Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://uruchi-portfolio.vercel.app/">Contact</a>
                </li>
            </ul>
        </div>
    </div>
...
<%--                    <form:form action="handleForm" method="post" modelAttribute="jobPost">--%>
                    <form:form action="handleForm" method="post" modelAttribute="javaPost">
                        <div class="mb-1">
